...
- (void)viewDidLoad {
    ...
    UINavigationController *searchResultsController = [[self storyboard] instantiateViewControllerWithIdentifier:@"iOSBlogSearchResultsTableSearchResultsNavController"];
...
- (void)updateSearchResultsForSearchController:(UISearchController *)searchController {
    ...
    if (self.searchController.searchResultsController) {
        ...
        iOSBlogSearchResultsTableViewController *vc = (iOSBlogSearchResultsTableViewController *)navController.topViewController;
